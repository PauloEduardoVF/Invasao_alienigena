...
class Bullet(Sprite):
    '''Uma classe que administra projéteis disparados da espaçonave'''

    def __init__(self, ai_game):
        '''Cria um objeto projétil na posição atual da espaçonave'''
        super().__init__()
    ...
    def update(self):
        '''Desloca o projétil para cima na tela'''
